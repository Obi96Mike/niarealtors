...
// Comprehensive list of global country calling codes (E.164) for phone inputs.
// Source adapted from common public datasets used by country pickers.
export const countryCallingCodes: CountryCallingCode[] = [
  ...
  { code: "PS", name: "Palestinian Territory", dialCode: "+970" },
